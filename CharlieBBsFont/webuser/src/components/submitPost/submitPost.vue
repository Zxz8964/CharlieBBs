<template>
  <div class="submit__post">
    ...
    <div class="right__body">
        <RedditRules />
        <p class="text">Please be mindful of reddit's <span>content policy</span> and practice good <span>reddiquette</span>.</p>
        <LinksCard />
    </div>
  </div>
</template>
...
<script>
import Markdown from "./componentsInIt/markdown.vue"
import RedditRules from "./componentsInIt/redditRules.vue"
import LinksCard from "./componentsInIt/linksCard.vue"
export default {
    components: {
        Markdown,
        RedditRules,
